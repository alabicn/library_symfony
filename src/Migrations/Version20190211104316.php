 ...
 */
final class Version20190211104316 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book CHANGE details details VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE book CHANGE details details LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
