...
class __TwigTemplate_6175e29b3f7edd8515a7ed3aaa65694b552c8cae950d705cd40760427a4a681c extends Twig_Template
{
    private $source;
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    ";
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new Twig_Error_Runtime('Variable "form" does not exist.', 4, $this->source); })()), 'form');
        echo "
";
...
{% block body %}
    {{form(form)}}
{% endblock %}", "registration/register.html.twig", "C:\\wamp\\www\\library\\templates\\registration\\register.html.twig");
    }
}
