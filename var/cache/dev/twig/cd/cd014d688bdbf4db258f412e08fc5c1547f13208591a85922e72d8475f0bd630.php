...
";
    ...
    public function block_header($context, array $blocks = [])
    {
        ...
        // line 25
        if ((isset($context["title"]) || array_key_exists("title", $context))) {
            echo twig_escape_filter($this->env, (isset($context["title"]) || array_key_exists("title", $context) ? $context["title"] : (function () { throw new Twig_Error_Runtime('Variable "title" does not exist.', 25, $this->source); })()), "html", null, true);
        } else {
            echo "Header";
        }
        echo "</h1>
    ...
    public function block_flash($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new Twig_Error_Runtime('Variable "app" does not exist.', 65, $this->source); })()), "session", []), "flashbag", []), "get", [0 => "success"], "method"));
        ...
        echo "            ";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new Twig_Error_Runtime('Variable "app" does not exist.', 70, $this->source); })()), "session", []), "flashbag", []), "get", [0 => "info"], "method"));
        foreach ($context['_seq'] as $context["_key"] => $context["flash_message"]) {
            // line 71
        ...
        echo "            ";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new Twig_Error_Runtime('Variable "app" does not exist.', 75, $this->source); })()), "session", []), "flashbag", []), "get", [0 => "warning"], "method"));
        foreach ($context['_seq'] as $context["_key"] => $context["flash_message"]) {
            // line 76
        ...
        echo "            ";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new Twig_Error_Runtime('Variable "app" does not exist.', 80, $this->source); })()), "session", []), "flashbag", []), "get", [0 => "danger"], "method"));
        foreach ($context['_seq'] as $context["_key"] => $context["flash_message"]) {
            // line 81
...
<html lang=\"{{ app.request.locale }}\">
    <head>
        ...
        <title>
            {% block title %}
                {% if title is defined %}{{title}}{% else %}Title{% endif %} | Library
            {% endblock %}
        </title>
        {% block stylesheets %}
            {# bootstrap #}
                ...
                <ul class=\"navbar-nav ml-auto\">
                    ...
                    {% else %}
                        ...
                        <li class=\"nav-item {% if mainNavRegistration is defined %}active{% endif %}\">
                            <a class=\"nav-link\" href=\"{{path('app_registration_register')}}\">Sign Up</a>
                        </li>
                    {% endif %}
                </ul>
            </nav>
...
", "base.html.twig", "C:\\wamp\\www\\library\\templates\\base.html.twig");
    }
}
