...
// Returns the private 'App\Repository\LibraryRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\LibraryRepository.php';

return $this->privates['App\Repository\LibraryRepository'] = new \App\Repository\LibraryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
